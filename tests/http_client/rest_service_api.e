...
feature {NONE} -- Implementation
	...
	service_url (a_query: STRING; a_parameters: detachable ARRAY [detachable TUPLE [name: STRING; value: STRING]]): STRING
			-- Twitter url for `a_query' and `a_parameters'
		require
			a_query_attached: a_query /= Void
		do
			Result := url (service_api_url + a_query, a_parameters)
		ensure
